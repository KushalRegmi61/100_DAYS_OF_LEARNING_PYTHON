import csv
import pandas
data = pandas.read_csv(r"DAY_25_THREE_PORJECTS\squirrels_data_code\2018_Central_Park_Squirrel_Census_-_Squirrel_Data_20240402.csv")
...
print(sq_data)
sq_data.to_csv(r"DAY_25_THREE_PORJECTS\squirrels_data_code\sq_color_&_count.csv")