...
class Quizui():
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_img = tk.PhotoImage(file=r"DAY_34_TRIVIA_API_QUIZ_GAME\images\true.png")
        self.false_img = tk.PhotoImage(file=r"DAY_34_TRIVIA_API_QUIZ_GAME\images\false.png")
